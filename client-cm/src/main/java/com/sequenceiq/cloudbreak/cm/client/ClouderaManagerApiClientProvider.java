...
public class ClouderaManagerApiClientProvider {
    ...
    @Value("${cm.client.cluster.proxy.timeout:90000}")
    private Integer clusterProxyTimeout;

    @Value("${cm.client.connect.timeout.seconds:100}")
    private Integer connectTimeoutSeconds;

    @Value("${cm.client.read.timeout.seconds:100}")
    private Integer readTimeoutSeconds;

    @Value("${cm.client.write.timeout.seconds:100}")
